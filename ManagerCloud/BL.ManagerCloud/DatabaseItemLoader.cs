...
using BL.ManagerCloud.UnitOfWorks;
using DAL.ManagerCloud;
using DAL.ManagerCloud.Contracts;
using EF.ManagerCloud;
    ...
    internal class DatabaseItemLoader
    {
        ...
        public DataSource AddDataSource(Models.DataSource newDataSource)
        {
            ...
            using (var context = _contextFactory.CreateInstance())
            {
                ...
                addedDataSource = dataSourceUnitOfWork.TryAdd(newDataSource, dataSourceSearchCriteria, true);
            }
        ...
        public Client AddClient(Models.Client newClient)
        {
            ...
            using (var context = _contextFactory.CreateInstance())
            {
                ...
                addedClient = clientUnitOfWork.TryAdd(newClient, clientSearchCriteria, true);
            }
        ...
        public Item AddItem(Models.Item newItem)
        {
            ...
            using (var context = _contextFactory.CreateInstance())
            {
                ...
                addedItem = itemUnitOfWork.TryAdd(newItem, itemSearchCriteria, true);
            }
        ...
        public Sale AddSale(Models.Sale newSale)
        {
            ...
            using (var context = _contextFactory.CreateInstance())
            {
                ...
                addedSale = saleUnitOfWork.TryAdd(newSale, saleSearchCriteria, true);
            }
